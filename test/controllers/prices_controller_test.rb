...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { estado: @price.estado, hora_fin: @price.hora_fin, hora_inicio: @price.hora_inicio, tipo_carro: @price.tipo_carro, valor: @price.valor } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { estado: @price.estado, hora_fin: @price.hora_fin, hora_inicio: @price.hora_inicio, tipo_carro: @price.tipo_carro, valor: @price.valor } }
