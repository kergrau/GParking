...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { par_address: @parking.par_address, par_latitude: @parking.par_latitude, par_longitude: @parking.par_longitude, par_name: @parking.par_name, par_state: @parking.par_state } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { par_address: @parking.par_address, par_latitude: @parking.par_latitude, par_longitude: @parking.par_longitude, par_name: @parking.par_name, par_state: @parking.par_state } }
